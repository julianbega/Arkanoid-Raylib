...
int main(void)
{
	// bordes de mapa
	{
		...
		BordeRight.height = screenHeight;
		BordeRight.width = 10;
		BordeRight.x = screenWidth * 0.6;
		BordeRight.y = 0;
		BordeLeft.height = screenHeight;
		BordeLeft.width = 10;
		BordeLeft.x = 0;
		BordeLeft.y = 0;
		BordeUp.height = 10;
		BordeUp.width = screenWidth * 0.6;
		BordeUp.x = 0;
		BordeUp.y = 0;
		BordeBot.height = 10;
		BordeBot.width = screenWidth*0.6;
		BordeBot.x = 0;
		BordeBot.y = screenHeight - BordeBot.height;
	}
	...
	while (!WindowShouldClose())    // Detect window close button or ESC key
	{
		...
		{
			if (P1.Rec.y > 0) {
				if (IsKeyDown(KEY_A)) P1.Rec.x -= 2.0f;
			}
			if (P1.Rec.y < screenHeight - P1.Rec.height) {
				if (IsKeyDown(KEY_D)) P1.Rec.x += 2.0f;
			}
...
/*
		...
		DrawRectangle(P1.Rec.x, P1.Rec.y, P1.Rec.width, P1.Rec.height, P1.PlayerColor);
		DrawRectangle(BordeRight.x, BordeRight.y, BordeRight.width, BordeRight.height, LIGHTGRAY);
		DrawRectangle(BordeLeft.x, BordeLeft.y, BordeLeft.width, BordeLeft.height, LIGHTGRAY);
		DrawRectangle(BordeUp.x, BordeUp.y, BordeUp.width, BordeUp.height, LIGHTGRAY);
		DrawRectangle(BordeBot.x, BordeBot.y, BordeBot.width, BordeBot.height, LIGHTGRAY);
